...
public BikeParkingMap( String Vno ,String Wheel,String type,String phno)
{
...
mapJlabel.setMaximumSize(new Dimension(100, 200));
mapJlabel.setPreferredSize(new Dimension(100, 200));
String ss="cell"+" "+i+" "+j;
